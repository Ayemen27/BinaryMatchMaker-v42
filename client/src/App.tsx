...
import TelegramPaymentDirect from "@/pages/telegram-payment-direct"; // إضافة صفحة دفع تلجرام المباشرة
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/telegram-payment-direct" component={TelegramPaymentDirect} />
